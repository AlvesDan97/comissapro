(function () {
  ...
  style.textContent = `
    #cookieBar{position:fixed;left:0;right:0;bottom:0;z-index:300;padding:14px;background:rgba(8,9,10,.92);backdrop-filter:blur(16px);border-top:1px solid rgba(255,255,255,.12)}
